...
export type ArticlesQuery = { allContentfulBlogPost: { edges: Array<{ node: Pick<ContentfulBlogPost, 'id' | 'title' | 'slug'> }> } };

export type TagsQueryVariables = Exact<{ [key: string]: never; }>;


export type TagsQuery = { allContentfulBlogPost: { nodes: Array<Pick<ContentfulBlogPost, 'id' | 'tags'>> } };
...
export type Unnamed_1_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
    ...
    Pick<ContentfulBlogPost, 'title' | 'slug' | 'createdAt' | 'tags' | 'id'>
    & { fromNow: ContentfulBlogPost['createdAt'] }
    & { body?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }> }
  )> };
...
export type Unnamed_2_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description'>
      & { author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'url'>> }
    )> }>, allContentfulBlogPost: { nodes: Array<Pick<ContentfulBlogPost, 'id' | 'title' | 'slug' | 'createdAt'>> } };
